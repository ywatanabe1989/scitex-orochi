...
def check_write_allowed(
    ...
    if workspace_id is not None:
        try:
            from apps.hub.models import Channel as _Channel
...
def _check_dm_write_allowed(
    ...
    try:
        from apps.hub.models import Channel as _Channel
        from apps.hub.models import DMParticipant as _DMParticipant
    except Exception:
        return False
...
def check_membership_allowed(
    ...
    * If the sender is a synthetic agent user (``agent-*`` — see
    ...
    try:
        from apps.hub.models import Channel as _Channel
        from apps.hub.models import ChannelMembership as _Membership
    except Exception:
        return True
