...
export function buildLabelsHtml(labels) {
...
export function buildDetailInnerHtml(issue) {
...
export function _ensureDetailFilled(el) {
...
export function buildGroupHtml(group, issues) {
...
export function attachTodoEvents(container) {
...
export function _backgroundFillDetails(container) {
...
(globalThis as any)._todoIssuesByNumber = (typeof _todoIssuesByNumber !== 'undefined' ? _todoIssuesByNumber : undefined);
