...
export var _blockersRefreshTimer = null;
export var _BLOCKERS_POLL_MS = 60 * 1000;

export function _renderBlockersSidebar(issues) {
...
export function startBlockersPoll() {
  fetchBlockers();
