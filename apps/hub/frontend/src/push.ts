...
export var pushSupported = "PushManager" in window && "serviceWorker" in navigator;
export var pushSubscription = null;
export var pushEnabled = localStorage.getItem("orochi_push_enabled") === "true";
...
export function updatePushToggleUI() {
