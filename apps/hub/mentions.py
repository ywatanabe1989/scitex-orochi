...
def resolve_mention_targets(
    ...
    *,
    ...
    from apps.hub.models import AgentGroup, WorkspaceMember
    ...
    for token in tokens:
        ...
        from apps.hub.models import Channel, ChannelMembership
...
def expand_mentions_and_notify(
    *,
    ...
    from apps.hub.models import Channel, ChannelMembership, Message, Workspace
