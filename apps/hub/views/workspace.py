...
from apps.hub.models import Channel, Message, Workspace, WorkspaceMember, WorkspaceToken
from apps.hub.views._helpers import bare_url, get_workspace, workspace_url
...
def workspace_settings_view(request, slug=None):
    ...
    from apps.hub.models import InviteRequest, WorkspaceInvitation
...
def _handle_settings_post(request, workspace):
    ...
    """
    from apps.hub.models import WorkspaceInvitation
    ...
    if action == "create_token":
        ...
        from apps.hub.models import InviteRequest
