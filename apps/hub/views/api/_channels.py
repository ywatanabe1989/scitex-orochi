...
from apps.hub.views._helpers import resolve_workspace_and_actor
...
def api_channel_members(request, slug=None):
    ...
    """
    from apps.hub.models import ChannelMembership
    ...
    if request.method in ("POST", "PATCH", "DELETE"):
        ...
        from apps.hub.consumers._helpers import ABOLISHED_AGENT_CHANNELS
...
def api_stats(request, slug=None):
    ...
    from apps.hub.models import Message
    ...
    from apps.hub.registry import get_online_count
