...
from apps.hub.views.api._common import (
    JsonResponse,
    WorkspaceToken,
    csrf_exempt,
    get_workspace,
...
def api_agents(request):
    ...
    if not (request.user and request.user.is_authenticated):
        ...
        from apps.hub.models import WorkspaceToken
    ...
    from apps.hub.models import PinnedAgent
...
def api_agent_profiles(request):
    ...
    from apps.hub.registry import _agents, _lock
...
def api_agent_health(request):
    ...
    from apps.hub.registry import set_health
...
def api_subagents_update(request):
    ...
    from apps.hub.registry import set_subagents
...
def api_agents_purge(request):
    ...
    """
    from apps.hub.registry import purge_agent, purge_all_offline
...
def api_agent_snapshot(request, name):
    ...
    from apps.hub.models import AgentSnapshot
...
def api_agent_owner(request, name):
    ...
    if err is not None:
        return err
    from apps.hub.registry import _agents, _lock, get_agents
...
def api_agent_session_meta(request, name, instance_uuid):
    ...
    if err is not None:
        return err
    from apps.hub.models import AgentSession
