...
class ActiveSessionCounterTests(TestCase):
    ...
    def test_register_connection_idempotent(self):
        from apps.hub.registry import active_session_count, register_connection
    ...
    def test_get_agents_active_sessions_zero_when_no_connections(self):
        from apps.hub.registry import get_agents, register_agent
    ...
    def test_empty_or_invalid_args_safe(self):
        from apps.hub.registry import register_connection, unregister_connection
