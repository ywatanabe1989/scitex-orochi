...
from apps.hub.models import Workspace, WorkspaceToken
...
class UpdateEchoPongRegistryTests(TestCase):
    ...
    def test_register_agent_preserves_echo_fields_across_heartbeat(self):
        ...
        from apps.hub.registry import _agents, register_agent, update_echo_pong
    ...
    def test_get_agents_payload_surfaces_echo_fields(self):
        ...
        from apps.hub.registry import get_agents, update_echo_pong
