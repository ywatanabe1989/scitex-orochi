...
def _fake_consumer(agent_name: str, workspace_id: int):
    ...
    """
    from apps.hub.consumers._agent import AgentConsumer
...
class InboundMessageAdvancesEchoTimestampTest(TestCase):
    ...
    def setUp(self):
        from apps.hub.registry import _agents, _connections, register_agent
    ...
    def test_inbound_message_sets_last_nonce_echo_at(self):
        ...
        """
        from apps.hub.consumers._agent_message import handle_agent_message
        from apps.hub.registry import _agents
    ...
    def test_inbound_message_does_not_overwrite_rtt(self):
        ...
        """
        from apps.hub.consumers._agent_message import handle_agent_message
        from apps.hub.registry import _agents, update_echo_pong
...
class NonceProbeIndependenceTest(TestCase):
    ...
    def test_mark_echo_alive_alone_populates_led_field(self):
        ...
        from apps.hub.registry import _agents, mark_echo_alive
    ...
    def test_payload_surfaces_field_without_rtt(self):
        ...
        """
        from apps.hub.registry import get_agents, mark_echo_alive
