...
from apps.hub.models import Channel, ChannelMembership, Workspace
...
class ChannelMembershipSignalTest(TestCase):
    ...
    def _patched_send(self):
        ...
        return (
            patch(
                "apps.hub.signals.get_channel_layer", return_value=layer
            ),
            patch(
                "apps.hub.signals.list_sibling_channels",
    ...
    def test_no_send_when_no_sibling_connections(self):
        ...
        with patch(
            ...
            "apps.hub.signals.list_sibling_channels", return_value=[]
...
class AgentSubsRefreshHandlerTest(TestCase):
    ...
    def test_refresh_broadcasts_agent_info_on_change(self):
        ...
        with patch("apps.hub.registry.register_agent") as reg:
            async_to_sync(consumer.agent_subs_refresh)(
                {
                    "type": "agent.subs_refresh",
                    "agent": "worker-q",
