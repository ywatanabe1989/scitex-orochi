...
from apps.hub import auto_dispatch as ad
from apps.hub.auto_dispatch import (
...
from apps.hub.models import Channel, Message, Workspace
from apps.hub.registry import _agents, _lock, register_agent, update_heartbeat
