...
class AgentMetaOAuthRegisterTest(TestCase):
    ...
    def test_register_accepts_oauth_fields(self):
        from apps.hub.registry import _agents as _reg_agents
...
class AgentRegisterAuthMatrixTest(TestCase):
    ...
    def test_heartbeat_schema_version_accepted(self):
        ...
        from apps.hub.views.api._agents_register import CURRENT_HEARTBEAT_SCHEMA
    ...
    def test_heartbeat_schema_version_too_old_returns_409(self):
        ...
        from apps.hub.views.api import _agents_register as mod
...
class SingletonProxyMetadataTest(TestCase):
    ...
    def setUp(self):
        ...
        from apps.hub.registry import _agents as _reg
