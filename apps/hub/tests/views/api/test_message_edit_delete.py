...
def _noop_ws_broadcast():
    ...
    return (
        patch("apps.hub.views.api._reactions.get_channel_layer", return_value=layer_mock),
        patch("apps.hub.views.api._reactions.async_to_sync", side_effect=lambda f: lambda *a, **kw: None),
    )
