...
from apps.hub.channel_acl import check_membership_allowed, check_write_allowed
...
async def handle_agent_message(consumer, content):
    ...
    if ch_name.startswith("dm:"):
        from apps.hub.views.api import _ensure_dm_channel
    ...
    from apps.hub.registry import mark_activity, mark_echo_alive
    ...
    try:
        from apps.hub.push import send_push_to_subscribers_async
    ...
    try:
        from apps.hub.mentions import expand_mentions_and_notify
