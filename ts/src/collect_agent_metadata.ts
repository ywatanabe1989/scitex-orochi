 ...
 *
 * Shells out to `python3 ~/.scitex/orochi/scripts/collect_agent_metadata.py <agent>`
...
const SCRIPT_PATH = join(homedir(), ".scitex/orochi/scripts/collect_agent_metadata.py");
