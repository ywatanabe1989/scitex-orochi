...
description: SciTeX CLI conventions continued — standard flags, exit codes, output streams, help text requirements, env vars (SCITEX_* prefix rule), MCP parity, no-interactive-prompts rule, audit checklist, and cross-references. (Part 3 of 3 — split from 56_convention-cli-extras.md.)
---

> Part 3 of the CLI conventions series. See [`20_convention-cli.md`](20_convention-cli.md) for the core shape and [`56_convention-cli-extras.md`](56_convention-cli-extras.md) for noun-verb shape, deprecation policy, help-display, and flat keepers.
