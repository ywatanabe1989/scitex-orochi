...
## 5–13. Flags, Exit Codes, Streams, Env Vars, MCP Parity, Audit Checklist

See [`81_convention-cli-extras-b.md`](81_convention-cli-extras-b.md) for §§5–13 (split to keep files under the 10 KB skill monolith limit).
