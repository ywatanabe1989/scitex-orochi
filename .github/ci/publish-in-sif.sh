...
# (project=scitex-orochi, owner=ywatanabe1989, repo=scitex-orochi,
...
TMPDIR="/tmp/publish-scitex_orochi-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-orochi dist/* uploaded to PyPI via manual OIDC trusted publishing"
