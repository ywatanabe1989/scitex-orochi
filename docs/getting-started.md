...
The same hook ring buffer also populates the per-agent detail view's `sac_hooks_recent_tools`, `sac_hooks_recent_prompts`, `sac_hooks_agent_calls`, `sac_hooks_background_tasks`, and `sac_hooks_tool_counts` panels.
