...
The same hook ring buffer also populates the per-agent detail view's `recent_tools`, `recent_prompts`, `sac_hooks_agent_calls`, `background_tasks`, and `sac_hooks_tool_counts` panels.
