"""Mirror test for ``src/scitex_orochi/_daemons/_auditor_haiku/_rules.py``.
...
_SRC = _REPO / "src" / "scitex_orochi" / '_daemons' / '_auditor_haiku' / '_rules.py'


def test_rules_surface():
    # Arrange
