"""Mirror test for ``src/scitex_orochi/_cli/commands/agent_cmd/_status.py``.
...
_SRC = _REPO / "src" / "scitex_orochi" / '_cli' / 'commands' / 'agent_cmd' / '_status.py'
