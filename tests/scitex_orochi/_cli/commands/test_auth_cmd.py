"""Mirror test for ``src/scitex_orochi/_cli/commands/auth_cmd.py``.
...
_SRC = _REPO / "src" / "scitex_orochi" / '_cli' / 'commands' / 'auth_cmd.py'


def test_auth_cmd_surface():
    # Arrange
