"""Mirror test for ``src/scitex_orochi/_agent_container_bridge/connector.py``.
...
_SRC = _REPO / "src" / "scitex_orochi" / '_agent_container_bridge' / 'connector.py'


def test_connector_surface():
    # Arrange
    ...
    # Assert
    assert "discover_server" in funcs
