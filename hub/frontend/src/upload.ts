...
export var _attachmentTray = null;

export function _ensureAttachmentTray() {
...
export function _renderAttachmentTray() {
...
export var msgInput = document.getElementById("msg-input");
...
export var PASTE_TEXT_ATTACH_MIN_CHARS = 1500;
export var PASTE_TEXT_ATTACH_MIN_LINES = 25;

export function _pastedTextShouldAttach(text) {
...
export function _buildPastedTextFile(text) {
...
(globalThis as any).pendingAttachments = (typeof pendingAttachments !== 'undefined' ? pendingAttachments : undefined);
