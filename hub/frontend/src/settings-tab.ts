...
export function wireSettingsModeTabs(container) {
...
export function _wireSettingsIconPicker(container) {
...
export function wireSettingsForms(container) {
