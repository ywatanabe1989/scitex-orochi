// @ts-nocheck
import { fetchHumanProfiles } from "./agent-icons";
import { fetchAgents } from "./app/sidebar-agents";
import { fetchStats } from "./app/sidebar-stats";
import { getWorkspaceIcon } from "./app/utils";
import { connect, startRestPolling, wsConnected } from "./app/websocket";
import { loadHistory } from "./chat/chat-history";
import { hideMentionDropdown, refreshAgentNames } from "./mention";
import { closeReactionPicker, reactionPicker } from "./reactions";
import { fetchResources } from "./resources-tab/tab";
import { closeSketch, sketchOverlay } from "./sketch";
...
document.addEventListener("keydown", function (e) {
  ...
  /* 4. Thread panel */
  if (typeof (globalThis as any).threadPanel !== "undefined" && (globalThis as any).threadPanel) {
    closeThreadPanel();
    e.preventDefault();
    return;
  }
