// @ts-nocheck
import { apiUrl, fuzzyMatch } from "./app/utils";
import { jumpToMsg } from "./chat/chat-attachments";
import { _fm } from "./filter/state";
...
export const closeSearchPalette = (window as any).closeSearchPalette;
export const openSearchPalette = (window as any).openSearchPalette;
