// @ts-nocheck
import { agentIdentity, cachedAgentIcons, cachedHumanIcons, getSnakeIcon } from "./agent-icons";
...
export const renderAgentBadgeSvg = (window as any).renderAgentBadgeSvg;
