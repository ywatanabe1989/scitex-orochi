// @ts-nocheck
import { _wireOverviewControls, _wireTopoEscCancel } from "./controls";
import { refreshActivityFromApi, startActivityAutoRefresh } from "./data";
import { _applyOverviewViewClass, _renderActivityCards } from "./row";
import { renderSidebarMemory } from "../app/sidebar-memory-options";
...
export function renderActivityTab() {
  ...
  if ((globalThis as any)._overviewFilter) {
    var q = (globalThis as any)._overviewFilter.toLowerCase();
