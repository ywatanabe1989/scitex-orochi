...
import { _topoAutoSaveActiveSlot } from "./multiselect";
...
export var _paneShowRaw = false; /* false = strip ANSI (clean), true = raw */
...
export var _activityDetailCache = {};
export var _activityDetailInflight = {};
...
export var _activityPaneExpanded = {}; /* name -> bool */
var _activityFollowAgent = null;
var _activityFollowTimer = null;
export var ACTIVITY_FOLLOW_INTERVAL_MS = 3000;
...
export var _topoViewBoxHistory = []; /* back stack (undo) */
export var _topoViewBoxFuture = []; /* forward stack (redo) */
...
export var TOPO_SEEK_WINDOW_MS = 5 * 60 * 1000; /* 5 minutes */
export var _topoSeekEvents = [];
...
export var _topoSeekSpeed = 1; /* playback speed multiplier */
...
export var _topoLandingStacks = Object.create(null);
export var _TOPO_LANDING_DUR_MS = 1300;
export var _TOPO_LANDING_STACK_MAX = 4;
export var _TOPO_LANDING_STEP_PX = 18;
...
export var _topoStickyEdges = {};
export function _topoStickyKey(agent, channel) {
...
export function _topoSaveHidden() {
  try {
...
export function _topoHiddenSignature() {
  return (
    "h:" +
...
export function _topoHide(kind, name) {
  if (!kind || !name) return;
  var hn =
...
export function _topoUnhide(kind, name) {
...
export function _topoUnhideAll() {
...
export var _topoManualPositions = {};
try {
...
export function _topoManualKey(kind, name) {
  return String(kind || "") + ":" + String(name || "");
}
export function _topoSaveManualPositions() {
  try {
    localStorage.setItem(
...
export function _topoSetManualPosition(kind, name, x, y) {
  if (!kind || !name) return;
...
export function _topoClearManualPosition(kind, name) {
  delete _topoManualPositions[_topoManualKey(kind, name)];
  _topoSaveManualPositions();
  _topoLastSig = "";
}
export function _topoManualPositionsSignature() {
...
export function _topoApplyStickyEdges() {
...
export var _topoChannelPermsInflight = Object.create(null); /* channel → bool */
export var TOPO_PERMS_TTL_MS = 30000;
 ...
 * +Save button). */
export var _TOPO_POOL_SEL_KEY = "orochi.topoPoolSelection";
...
export var _TOPO_POOL_MEM_KEY_LEGACY = "orochi.topoPoolMemories";
export function _topoMemWorkspaceKey() {
  var ws =
...
export var _TOPO_POOL_MEM_MAX = 5;
...
export var _topoPoolMemories = (function _loadPoolMem() {
  try {
...
export var _TOPO_ACTIVE_MEM_KEY = "orochi.topoActiveMemSlot";
...
export var TOPO_SEEK_HEAT_BINS = 200;
export var TOPO_SEEK_HEAT_THROTTLE_MS = 250;
var _topoSeekHeatLastSig = "";
var _topoSeekHeatLastPaint = 0;

// Expose cross-file mutable state via globalThis:
(globalThis as any)._activityFollowAgent = (typeof _activityFollowAgent !== 'undefined' ? _activityFollowAgent : undefined);
(globalThis as any)._activityFollowTimer = (typeof _activityFollowTimer !== 'undefined' ? _activityFollowTimer : undefined);
(globalThis as any)._overviewColor = (typeof _overviewColor !== 'undefined' ? _overviewColor : undefined);
(globalThis as any)._overviewExpanded = (typeof _overviewExpanded !== 'undefined' ? _overviewExpanded : undefined);
(globalThis as any)._overviewFilter = (typeof _overviewFilter !== 'undefined' ? _overviewFilter : undefined);
(globalThis as any)._overviewSort = (typeof _overviewSort !== 'undefined' ? _overviewSort : undefined);
(globalThis as any)._overviewView = (typeof _overviewView !== 'undefined' ? _overviewView : undefined);
(globalThis as any)._topoActiveMemSlot = (typeof _topoActiveMemSlot !== 'undefined' ? _topoActiveMemSlot : undefined);
(globalThis as any)._topoChannelPerms = (typeof _topoChannelPerms !== 'undefined' ? _topoChannelPerms : undefined);
(globalThis as any)._topoChannelPermsFetchedAt = (typeof _topoChannelPermsFetchedAt !== 'undefined' ? _topoChannelPermsFetchedAt : undefined);
(globalThis as any)._topoHidden = (typeof _topoHidden !== 'undefined' ? _topoHidden : undefined);
(globalThis as any)._topoLastExpanded = (typeof _topoLastExpanded !== 'undefined' ? _topoLastExpanded : undefined);
(globalThis as any)._topoLastPositions = (typeof _topoLastPositions !== 'undefined' ? _topoLastPositions : undefined);
(globalThis as any)._topoLastSig = (typeof _topoLastSig !== 'undefined' ? _topoLastSig : undefined);
(globalThis as any)._topoPoolSelection = (typeof _topoPoolSelection !== 'undefined' ? _topoPoolSelection : undefined);
(globalThis as any)._topoSeekHeatLastPaint = (typeof _topoSeekHeatLastPaint !== 'undefined' ? _topoSeekHeatLastPaint : undefined);
(globalThis as any)._topoSeekHeatLastSig = (typeof _topoSeekHeatLastSig !== 'undefined' ? _topoSeekHeatLastSig : undefined);
(globalThis as any)._topoSeekInteracting = (typeof _topoSeekInteracting !== 'undefined' ? _topoSeekInteracting : undefined);
(globalThis as any)._topoSeekLastFrameTs = (typeof _topoSeekLastFrameTs !== 'undefined' ? _topoSeekLastFrameTs : undefined);
(globalThis as any)._topoSeekMode = (typeof _topoSeekMode !== 'undefined' ? _topoSeekMode : undefined);
(globalThis as any)._topoSeekPlaying = (typeof _topoSeekPlaying !== 'undefined' ? _topoSeekPlaying : undefined);
(globalThis as any)._topoSeekRafId = (typeof _topoSeekRafId !== 'undefined' ? _topoSeekRafId : undefined);
(globalThis as any)._topoSeekReplayInProgress = (typeof _topoSeekReplayInProgress !== 'undefined' ? _topoSeekReplayInProgress : undefined);
(globalThis as any)._topoSeekTime = (typeof _topoSeekTime !== 'undefined' ? _topoSeekTime : undefined);
(globalThis as any)._topoSeekWired = (typeof _topoSeekWired !== 'undefined' ? _topoSeekWired : undefined);
(globalThis as any)._topoSizeBy = (typeof _topoSizeBy !== 'undefined' ? _topoSizeBy : undefined);
(globalThis as any)._topoViewBox = (typeof _topoViewBox !== 'undefined' ? _topoViewBox : undefined);
(globalThis as any)._topoZoomWired = (typeof _topoZoomWired !== 'undefined' ? _topoZoomWired : undefined);
(globalThis as any).activityRefreshTimer = (typeof activityRefreshTimer !== 'undefined' ? activityRefreshTimer : undefined);
