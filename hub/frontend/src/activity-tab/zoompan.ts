 ...
 * topology SVG. State lives in (globalThis as any)._topoViewBox so heartbeat-driven
...
export function _wireTopoZoomPan(grid, W, H) {
  if ((globalThis as any)._topoZoomWired || !grid) return;
  (globalThis as any)._topoZoomWired = true;
  ...
  function _pushVB() {
    if ((globalThis as any)._topoViewBox)
      _topoViewBoxHistory.push({
        x: (globalThis as any)._topoViewBox.x,
        y: (globalThis as any)._topoViewBox.y,
        w: (globalThis as any)._topoViewBox.w,
        h: (globalThis as any)._topoViewBox.h,
      });
  ...
  function _zoomAt(svg, factor, cx, cy) {
    var vb = (globalThis as any)._topoViewBox || { x: 0, y: 0, w: W, h: H };
    ...
    _pushVB();
    (globalThis as any)._topoViewBox = { x: nx, y: ny, w: nw, h: nh };
    _applyVB(svg, (globalThis as any)._topoViewBox);
  }
  function _popVB(svg) {
    if (!_topoViewBoxHistory.length) return;
    /* Save current state onto the future stack so Forward can redo. */
    _topoViewBoxFuture.push(
      (globalThis as any)._topoViewBox
        ? {
            x: (globalThis as any)._topoViewBox.x,
            y: (globalThis as any)._topoViewBox.y,
            w: (globalThis as any)._topoViewBox.w,
    ...
    (globalThis as any)._topoViewBox = prev;
    _applyVB(svg, prev);
  }
  function _forwardVB(svg) {
    ...
    (globalThis as any)._topoViewBox = next;
    _applyVB(svg, next);
  }
  function _resetVB(svg) {
    _pushVB();
    (globalThis as any)._topoViewBox = null;
    _applyVB(svg, null);
  }
  ...
  grid.addEventListener("mousemove", function (ev) {
    ...
    if (dragging.mode === "zoom") {
      ...
      dragging.svg.setAttribute(
        "viewBox",
        (globalThis as any)._topoViewBox.x.toFixed(1) +
          " " +
          (globalThis as any)._topoViewBox.y.toFixed(1) +
          " " +
          (globalThis as any)._topoViewBox.w.toFixed(1) +
          " " +
          (globalThis as any)._topoViewBox.h.toFixed(1),
      );
    }
  });
  grid.addEventListener("mouseup", function (ev) {
    ...
    if (dragging.mode === "zoom") {
      ...
      if (w > 8 && h > 8) {
        _pushVB();
        (globalThis as any)._topoViewBox = { x: x, y: y, w: w, h: h };
        _applyVB(svg, (globalThis as any)._topoViewBox);
      }
      var rect = svg.querySelector(".topo-zoombox");
      ...
      if (lw > 3 && lh > 3) {
        ...
        var added = 0;
        Object.keys((globalThis as any)._topoLastPositions.agents || {}).forEach(function (name) {
          var pos = (globalThis as any)._topoLastPositions.agents[name];
          if (!pos) return;
          if (
            pos.x >= lx &&
            pos.x <= lx + lw &&
  ...
  document.addEventListener("keydown", function (ev) {
    ...
    if (ev.key === "Escape") {
      ...
      if ((globalThis as any)._topoDragState && (globalThis as any)._topoDragState.moved) {
        ev.preventDefault();
        _topoCleanupDrag();
        return;
      }
