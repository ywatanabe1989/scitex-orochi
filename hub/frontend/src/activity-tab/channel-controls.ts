// @ts-nocheck
import { _activityChannelRequest, _fetchActivityDetail } from "./data";
import { _activityDetailCache } from "./state";
...
export function _bindActivityChannelControls(grid, agentName) {
