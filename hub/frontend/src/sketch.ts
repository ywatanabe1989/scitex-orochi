// @ts-nocheck
import { apiUrl, sendOrochiMessage, userName } from "./app/utils";

/* Sketch Canvas -- freehand drawing tool */
/* globals: (globalThis as any).currentChannel, userName, sendOrochiMessage, token, apiUrl */

export var sketchOverlay = null;
export var sketchCanvas = null;
export var sketchCtx = null;
export var sketchDrawing = false;
export var sketchTool = "pen";
export var sketchColor = "#ffffff";
export var sketchLineWidth = 5;
export var SKETCH_COLORS = [
  "#ffffff",
  "#ef4444",
  "#f59e0b",
  "#22c55e",
...
export var SKETCH_WIDTHS = [2, 5, 10];
export var SKETCH_WIDTH_LABELS = ["Thin", "Med", "Thick"];
...
export function setupSketchEvents() {
...
export async function sendSketch() {
  ...
  try {
    ...
    var channel = (globalThis as any).currentChannel || "#general";
    sendOrochiMessage({
      type: "message",
      sender: userName,
      payload: {
