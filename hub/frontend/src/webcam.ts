...
export var webcamOverlay = null;
export var webcamVideo = null;
export var webcamStream = null;
export var webcamFacing = "environment";
export var webcamCaptureInput = null;
export var webcamOnKey = null;

export function _webcamEnsureFallbackInput() {
...
export function _webcamWireFallbackInput() {
...
export function _webcamOpenFallback() {
  var input = _webcamEnsureFallbackInput();
  _webcamWireFallbackInput();
  input.click();
}

export async function _webcamRequestStream(facing) {
...
export function _buildWebcamUI() {
...
export async function flipWebcam() {
...
export function _webcamStopStream() {
  if (webcamStream) {
...
export var _webcamBtn = document.getElementById("msg-webcam");
if (_webcamBtn) {
