...
export const cycleVoiceLang = (window as any).cycleVoiceLang;
export const isVoiceRecording = (window as any).isVoiceRecording;
export const toggleVoiceInput = (window as any).toggleVoiceInput;
export const voiceInputResetAfterSend = (window as any).voiceInputResetAfterSend;
