...
export function _termLoadAssets() {
...
export function _termRenderPicker() {
...
export function _termStatus(msg, cls) {
...
export function _termCloseExisting() {
  if (_termState.ws) {
    try {
      _termState.ws.close();
    } catch (_) {}
...
export function openTerminalForHost(host) {
  _termLoadAssets()
    .then(function () {
      _termCloseExisting();
...
export function _termHandleWindowResize() {
...
export function stopTerminalTab() {
