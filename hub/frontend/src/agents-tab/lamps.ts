// @ts-nocheck
import { livenessColor, paneStateColor } from "./state";
...
export function _buildIndicatorLamps(a, d) {
  var lamps = [];
  var liveness =
...
export function _renderIndicatorLamps(a, d) {
...
export function renderPaneStateBadge(paneState, stuckPromptText) {
