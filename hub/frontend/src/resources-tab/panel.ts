...
import { fetchConnectivity, renderConnectivityMap } from "../connectivity-map";
import { renderResources } from "./tab";
...
export var _machineIcons = (function _loadMachineIcons() {
  try {
...
export function _persistMachineIcons() {
  try {
...
export function setMachineIcon(name, emoji) {
...
export function _fmtMetricPct(p) {
...
export function _positionMachineTooltip(el, evt) {
...
export function showMachineTooltip(host, evt) {
  if (!host) return;
...
export var _machinesView = "cards";
try {
...
export function _applyMachinesViewVisibility() {
...
export var _machinesControlsWired = false;
export function _wireMachinesControls() {
...
export function barHtml(label, percent) {
