// @ts-nocheck
import { apiUrl, csrfToken, getWorkspaceIcon } from "./app/utils";
...
export const __orochiWorkspaceIcon = (window as any).__orochiWorkspaceIcon;
export const __orochiWorkspaceIconImage = (window as any).__orochiWorkspaceIconImage;
export const closeEmojiPicker = (window as any).closeEmojiPicker;
export const openEmojiPicker = (window as any).openEmojiPicker;
